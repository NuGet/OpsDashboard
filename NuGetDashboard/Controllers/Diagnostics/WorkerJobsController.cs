...
namespace NuGetDashboard.Controllers.Diagnostics
{
    ...
    public class WorkerJobsController : Controller
    {
        ...
        public WorkerJobsController()
        {
            ...
            registeredJobs.Add("CreateSupportRequestReportTask", 30);
            registeredJobs.Add("DummyTask", 30);
            registeredJobs.Add("CreatePingdomMonthlyReportTask", 60);
            registeredJobs.Add("CreatePingdomWeeklyReportTask", 5);
        }
